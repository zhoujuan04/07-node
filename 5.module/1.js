/*
1.文件模块 自己写的，引入模块 ../ ./
2.第三方模块 需要下载 引入时不需要加 ./ ../ 放在 node_modules
3.内置模块 核心模块 人家给你写好的 用法和第三方模块一样，不需要下载
...
//基本数据类型 string number boolean null undefined symbol Object ...
...
//方法一
//Gril.prototype.__proto__ = Person.prototype; //通过__proto__实现继承

//方法二
/*function create(proto) {
    function Fn() {}  //创建一个空函数 没有私有，没有公有属性
...
*/
//方法三
//Object.setPrototypeOf(Gril.prototype,Person.prototype);
